...
<a href="DataTable.jsp" class="btn btn-primary btn-success"><span class="glyphicon glyphicon-upload"></span> Back To List</a>
  ...
  <div class="card-body">
    <form id= "myForm" method="POST" action="addMedicine.jsp" >
  <div class="form-group row">
    <label for="medcinename" class="col-sm-2 col-form-label">Medicine Name</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="medicinename" name="mname" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="genericname" class="col-sm-2 col-form-label">Generic Name</label>
    <div class="col-sm-6">
      <input type="text" class="form-control" id="genericname" name="gname" required>
    </div>
  </div>
    <div class="form-group row">
    <label for="manufacturer" class="col-sm-2 col-form-label">Manufacturer</label>
    <div class="col-sm-6">
      <input type="text" 	class="form-control" id="manufacturer" name="mnftr" required>
    </div>
  </div>
      <div class="form-group row">
    ...
    <div class="col-sm-6">
          <select class="form-control" id="exampleFormControlSelect1" id="usage" name="usage" required>
          <%
while(rs.next())
{
...
%>
    ...
    <div class="col-sm-6">
          <select class="form-control" id="exampleFormControlSelect1" id="type" name="type" required>
          <%
while(ds.next())
{
